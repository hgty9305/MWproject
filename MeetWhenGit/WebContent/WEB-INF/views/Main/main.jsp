...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <c:if test="${empty sessionScope.loginUser}">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="boots_login.mw">로그인</a>
          </li>
          </c:if>
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="boots_MyPage.mw">회원정보</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="boots_calendar.mw">캘린더</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="/MeetWhen/member/logOut.mw">로그아웃</a>
          </li>
          </c:if>
        </ul>
  ...
  <section class="bg-light page-section" id="team">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">User Review</h2>
          <h3 class="section-subheading text-muted">만족한 유저들의 한마디들</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
