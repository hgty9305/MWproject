...
<script type="text/javascript">
	...
	function initialize() {
		var mapOp = {
			center : new google.maps.LatLng(32.728198, 54.739394), //중동
			zoom : 4,
	...
	var marker, i;
		...
		google.maps.event.addListener(map, 'click', function(event) {
			infowindow.close();
			map.setCenter(new google.maps.LatLng(32.728198, 54.739394));
			map.setZoom(4);
		});
	}
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading text-uppercase">Middle-East Map: <b id="contryName"></b></h2>
					...
					<ul style="list-style: none">
						<li>
							<div class="tab">
								...
								<button onclick="openCity(event, 'contry')" id="defaultOpen">Middle-East</button>
								<button onclick="location.href='map5.mw'">Asia</button>
								<button onclick="location.href='map6.mw'">Oceania</button>
								<button onclick="location.href='map7.mw'">N-America</button>
